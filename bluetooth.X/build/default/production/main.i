...
void writeEUSART( unsigned char d );
...
void __attribute__((picinterrupt(""))) geral( void )
{
    INTCONbits.GIE = 0;
...
void main(void)
{
    ...
    while(1)
    {
        switch (aux)
        {
            ...
            case 10:
                if(bordaSubidaB1()) aux = 2;
                if(bordaSubidaB2()) aux = 3;
                if(bordaSubidaB3()) aux = 100;
                break;

            case 20:
                if(bordaSubidaB1()) aux = 3;
                if(bordaSubidaB2()) aux = 1;
                if(bordaSubidaB3()) aux = 200;
                break;

            case 30:
                if(bordaSubidaB1()) aux = 1;
                if(bordaSubidaB2()) aux = 2;
                if(bordaSubidaB3()) aux = 300;
                if(B2() & B3()) aux = 666;
                break;
