...
{
    cmdLCD(0x01);
    writeLCD(0,0,"__            __"); _delay((unsigned long)((200)*(20000000/4000.0)));
    writeLCD(6,0,"B"); _delay((unsigned long)((600)*(20000000/4000.0)));
    writeLCD(7,0,"l"); _delay((unsigned long)((600)*(20000000/4000.0)));
    writeLCD(8,0,"u"); _delay((unsigned long)((600)*(20000000/4000.0)));
    writeLCD(9,0,"e"); _delay((unsigned long)((600)*(20000000/4000.0)));
    writeLCD(0,1,"    Tecnolog    "); _delay((unsigned long)((2500)*(20000000/4000.0)));
}
...

{
    ...
    writeLCD(0,0,"WALLACE PIRES   ");_delay((unsigned long)((1000)*(20000000/4000.0)));
    writeLCD(0,1,"MATEUS PINHEIRO ");_delay((unsigned long)((1000)*(20000000/4000.0)));
    writeLCD(0,0,"                ");
    writeLCD(0,0,"GUI. RIBEIRO    ");_delay((unsigned long)((1000)*(20000000/4000.0)));
    writeLCD(0,1,"                ");
    writeLCD(0,1,"GABRIEL GENU    ");_delay((unsigned long)((1000)*(20000000/4000.0)));
    writeLCD(0,0,"                ");
    writeLCD(0,0,"ERIC SANTOS     ");_delay((unsigned long)((1000)*(20000000/4000.0)));
    writeLCD(0,1,"                ");
    writeLCD(0,1,"LINCON NOVAIS   ");_delay((unsigned long)((1000)*(20000000/4000.0)));
    writeLCD(0,0,"                ");_delay((unsigned long)((300)*(20000000/4000.0)));

    cmdLCD(0x01);_delay((unsigned long)((200)*(20000000/4000.0)));
    writeLCD(0,0,"      ARRI      ");_delay((unsigned long)((500)*(20000000/4000.0)));
    writeLCD(0,1,"     EGUAAA     ");_delay((unsigned long)((2500)*(20000000/4000.0)));
    cmdLCD(0x01);_delay((unsigned long)((200)*(20000000/4000.0)));
    writeLCD(0,0,"XD *-*ARRI*-* XD");
    writeLCD(0,1,"!*-* EGUAAA *-*!");_delay((unsigned long)((1000)*(20000000/4000.0)));
    writeLCD(0,0,"50    ARRI    13");
    writeLCD(0,1,"13   EGUAAA   50");_delay((unsigned long)((700)*(20000000/4000.0)));
